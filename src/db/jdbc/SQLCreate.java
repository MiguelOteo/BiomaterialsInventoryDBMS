...
public class SQLCreate {
	...
	public static void SQLCreateClass(String args[]) {
		...
		try {
			...
			String table_1 = "CREATE TABLE beneficts "
					       + "(beneficts_id INTEGER PRIMARY KEY, "
					       + " type TEXT default 0)";
			...
			String table_2 = "CREATE TABLE category "
					       + "(category_id INTEGER REFERENCES beneficts(beneficts_id), "
					       + " category_name TEXT NOT NULL, "
					       + " penalization INTEGER default NULL, "
					       //Money interval//
			...
			String table_3 = "CREATE TABLE client "
			...
			String table_4 = "CREATE TABLE transaction "
			...
			String table_5 = "CREATE TABLE utility "
					       + "(utility_id INTEGER PRIMARY KEY AUTOINCREMENT, "
					       + " heat_cold TEXT default NULL, "
					       + " flexibility TEXT default 'no', "
					       + " ressistance TEXT default 'yes', "
					       + " pressure REAL NOT NULL default 1, "
					       + " strength REAL NOT NULL)";
			statement_5.execute(table_5);
			statement_5.close();
					       		
			Statement statement_6 = sqlite_connection.createStatement();
			String table_6 = "CREATE TABLE manteinance "
					       + "(manteinance_id INTEGER PRIMARY KEY AUTOINCREMENT, "
					       + " pressure REAL NOT NULL default 1, "
					       + " humidity INT NOT NULL default 50, "
					       + " O2_supply TEXT default 'no', "
					       + " light TEXT default 'no', "
		   ...
		   String table_7 = "CREATE TABLE biomaterial "
					       + "(biomaterial_id INTEGER PRIMARY KEY AUTOINCREMENT, "
					       + " utility_id INTEGER REFERENCES utility (utility_id), "
					       + " name_product TEXT NOT NULL REFERENCES transaction(product_name), "
					       + " price_unit INTEGER NULL default 1, "
					       + " avalible_units INTEGER NOT NULL, "
